...
<template>
    <div>
        ...
        <!--Nav-->
        <div class="bg-yellow-50 h-20 border-2 shadow-2x1">
            <div class="w-28">
                <img src="../img/logo.jpg" alt=""
                    style="width:74px; height:74px; margin-left:5px; border-radius: 19px;">
            </div>
            <div class="w-64 ease">
      ...
      ease-in-out">Send</button>
            ...
            <div
                ...
                <p class="text-sm text-center md:text-right">&copy;2020 Company. All rights reserved. | All rights
                    reserved</p>
            </div>
        </footer>
